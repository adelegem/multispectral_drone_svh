...
- `tools/` — release-time / maintenance helpers; not invoked by the pipeline. Currently `tools/checksums.R` (Phase 5.6): re-prints the canonical pipeline-output digests for verifying a fresh reproduction.
